...
#### 其它更新內容
* bug 修復
  * 不再注冊爲拉丁輸入法，修復 Caps Lock 切換輸入法時不能切換至英文的問題
...
#### Rime 算法庫變更集
  ...
  * 新增：中英文切換方式 `clear`，切換時清除未完成的輸入
  * 改進：長按 Shift（或 Control）鍵不觸發中英文切換
...
## 鼠鬚管 0.9.20 (2013-07-24)
  ...
  * 修復：自定義中英文切換鍵 `Control+space` 無法切回中文模式
...
## 鼠鬚管 0.9.18 (2013-04-26)
  ...
  * 修復：若非以 Caps Lock 鍵進入英文模式，
    按 Caps Lock 只切換大小寫，不返回中文模式
  * 變更：Alfred 2 初始進入英文模式
...
## 鼠鬚管 0.9.15.1 (2013-01-17)
  ...
  * 新增：Caps Lock 點亮時，切換到英文模式，輸出小寫字母<br/>
...
## 鼠鬚管 0.9.5 (2012-05-06)
  ...
  * 可選用Shift或Control爲中英文切換鍵，詳見 Issue 133
